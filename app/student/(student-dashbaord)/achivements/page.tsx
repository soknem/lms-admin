...
export default function Achievement() {
    ...
    const totalCourses = yearOfStudyData?.courseAchResponses.reduce((total: number, yearOfStudy: YearOfStudy) => {
            ...
            <section className="bg-lms-primary w-full sm:h-[172px] rounded-xl relative flex items-center justify-center p-8">
                <div className="flex flex-col gap-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white">
                        Welcome back, {studentData?.nameEn}!
                    </h2>
