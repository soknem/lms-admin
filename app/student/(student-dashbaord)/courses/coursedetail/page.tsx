...
import { selectError, selectLoading, setError, setLoading } from "@/lib/features/student/course/studentCourseSlice";
import { useGetStudentCourseDetailQuery } from "@/lib/features/student/coursedetail/coursedetail";

export default function CourseDetailPage() {
    const dispatch = useDispatch<AppDispatch>();
    const { data = {}, error, isLoading } = useGetStudentCourseDetailQuery();
