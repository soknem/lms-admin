      ...
      <main className="flex flex-col h-full w-full p-9">
        ...
        <section className="flex lg:hidden gap-9 py-8">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-lg lg:text-3xl font-bold">{allData?.nameEn}</h3>
            <div className="flex items-center gap-3">
              <FaBook className="w-4 h-4 text-lms-primary" />
              <p className="text-sm lg:text-lg text-gray-800 font-semibold">{allData?.courses.length} Courses</p>
            </div>
          </div>
        </section>
