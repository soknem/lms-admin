import {
  ...
  export default function VideoComponent() {
    return (
      <div className="items-center  p-[35px] bg-white rounded-lg my-10">
      <h1 className="text-[36px] font-bold mb-4">Course Video</h1>
      <p className="text-gray_80 text-[18px] mb-6">
            ...
            <AccordionContent className="ml-4 mb-4">
              {section.videos.length > 0 ? (
                 ...
                 {section.videos.map((video, vidIndex) => (
                   <li key={vidIndex} className="flex justify-between items-center py-2 px-4 hover:bg-gray-100 hover:text-primary text-[18px] rounded-md ">
                     <div className="flex items-center space-x-[20px]">
                       <FaCirclePlay className="text-primary w-[26px] h-[26px]" />
