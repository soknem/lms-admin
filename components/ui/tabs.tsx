...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-white p-2 text-muted-foreground gap-4",
      className
    )}
    {...props}
  />
