            ...
            <div className='flex items-center justify-between gap-4 my-4 '>
                    ...
                    <PopoverContent className="w-[200px] p-0 bg-white" align="start">
                        ...
                        {selectedProgram && (
                            <Button className='bg-slate-50 hover:bg-slate-100 w-full rounded-none '
                                    onClick={() => handleReset('studyProgram')}>Reset</Button>
                        )}
                    </PopoverContent>
                </Popover>
                ...
                <Popover open={openYear} onOpenChange={setOpenYear}>
                    ...
                    <PopoverContent className="w-[200px] p-0 bg-white" align="start">
                        ...
                        {selectedYear && (
                            <Button className='bg-slate-50 hover:bg-slate-100 w-full rounded-none '
                                    onClick={() => handleReset('year')}>Reset</Button>
                        )}
                    </PopoverContent>
                </Popover>
                ...
                <Popover open={openSemester} onOpenChange={setOpenSemester}>
                    ...
                    <PopoverContent className="w-[200px] p-0 bg-white" align="start">
                        ...
                        {selectedSemester && (
                            <Button className='bg-slate-50 hover:bg-slate-100 w-full rounded-none '
                                    onClick={() => handleReset('semester')}>Reset</Button>
                        )}
                    </PopoverContent>
                </Popover>
...
function setSelectedYear(arg0: null) {
