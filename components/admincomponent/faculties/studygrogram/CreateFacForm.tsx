...
const CustomInput = ({field, setFieldValue}: any) => {
    ...
    return (
        <div className="w-full">
            ...
            <label
                htmlFor="file"
                className="border border-gray-300 hover:bg-lms-background text-gray-900 text-sm rounded-lg bg-white w-full h-[68px] border-dashed flex justify-center items-center cursor-pointer"
            >
                {!imagePreview ? (
...
export function CreateStudyProForm() {
    return (
        <Dialog>
            ...
            <DialogContent className="w-[480px] h-[80%] bg-white">
                ...
                >
                    {({setFieldValue}) => (
                        <Form className="py-4 rounded-lg ">
                            <ScrollArea className="h-[calc(80%-64px)] overflow-y-auto">
