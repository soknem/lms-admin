                ...
                <div className="mt-2">
                    ...
                    <div className="flex space-x-6">
                        <div className=" text-based text-gray-500 mt-4">
                            <span className="text-lms-primary mr-2  px-2 bg-lms-primary/10 rounded-xl text-md font-semibold">{subLabel1}</span>
                            <span className="text-lms-black-90 mr-2 font-semibold text-xl ">{value1}</span>
                        </div>
                        <div className="text-based text-gray-500 mt-4">
                            <span className="text-[#C29343] mr-2  px-2 bg-lms-accent/10 rounded-xl text-md font-semibold">{subLabel2}</span>
