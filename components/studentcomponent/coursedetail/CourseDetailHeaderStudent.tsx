            ...
            <section className="flex items-center mx-[90px]">
                ...
                <div className="flex items-center ml-[88px]">
                    <div className="flex -space-x-6 items-center">
                        {studentProfileImage?.length > 0 ? studentProfileImage.map((src, index) => (
                            <img
                                key={index}
                                src={src || "https://i.pinimg.com/564x/25/ee/de/25eedef494e9b4ce02b14990c9b5db2d.jpg"}
                                alt={`Student ${index + 1}`}
                                width={40}
                                height={40}
                    ...
                    <div className="mx-[100px] mt-5">
                        ...
                        <span className="ml-2 font-bold">
                            {classesStart ? new Date(classesStart).toLocaleDateString() : 'Unknown'}
                        </span>
                    </div>
                </div>
            </section>
