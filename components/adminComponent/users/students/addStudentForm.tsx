...
export function AddUserStudentForm() {
  ...
  return (
    <section className="flex flex-grow flex-col gap-6 bg-white border w-[1240px] h-[1020px] items-center-center rounded-[10px]">
      <section className="h-[90px] flex items-center px-9">
      ...
      >
        <TabsList className="dark:bg-gray-800 bg-lms-background w-full h-[150px]  rounded-none  ">
