                ...
                >
                    ...
                    <TabsContent value="document_upload">
                        <div className="grid grid-cols-2  gap-4 justify-center items-center mx-10 ">
                            {/*cv*/}
                            <div>
                                <RequiredFieldLabelComponent labelText="Upload CV"
                                                             labelClassName={` block mb-2 text-sm font-medium text-gray-900 dark:text-white`}/>
                    ...
                    <TabsContent value="permission">
                        <RequiredFieldLabelComponent labelText="Customize Permission"
                                                     labelClassName={` block text-lg font-medium text-gray-900 dark:text-white ml-10 mb-6`}/>
                        <div className="grid grid-cols-2 2xl:grid-cols-3 gap-4 justify-center items-center mx-10 ">
                        ...
                        <div className="flex items-center justify-end w-full pr-10 mt-6">
                            <Button type="submit" className="bg-lms-primary text-lms-white-80 hover:bg-lms-primary/90">Add
                                Staff</Button>
                        </div>
