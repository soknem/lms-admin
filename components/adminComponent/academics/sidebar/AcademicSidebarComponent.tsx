...
export default function AcademicSidebar() {
  ...
  return (
    <div className="h-full w-[270px] text-gray-800 text-lg font-medium flex flex-col bg-white py-9 ">
        ...
        {menuList.map((item, index) => (
          ...
          <Link key={index} href={item.path} passHref>
            ...
            <Button
              ...
              className={`group flex items-center justify-start px-9 w-[240px] bg-white hover:bg-background" ${
