    ...
    <>
        ...
        <div className="flex justify-between p-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <p className="flex text-lms-gray-30">
                Total:<span className="ml-2 text-black font-medium">10</span>
              </p>
              <p className="flex text-lms-gray-30">
                Male: <span className="ml-2 text-black font-medium">5</span>
              </p>
              <p className="flex text-lms-gray-30">
                Female: <span className="ml-2 text-black font-medium">5</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-4 w-full flex justify-between items-center">
        <div className="text-base text-muted-foreground">
          Showing <strong>1-5</strong> of <strong>10</strong> students
        </div>
